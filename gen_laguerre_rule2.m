...
%    a: the left endpoint of the interval of integration, and is currently fixed at 0
%    b: the scale factor in the exponential
%
% Modified:  24 February 2010; Author:  John Burkardt
%  
% Further modified by Lijun Li (add output args [x,w], reduce the verbose output, remove filename option)
%
